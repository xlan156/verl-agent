...
def default_compute_score(data_source, solution_str, ground_truth, extra_info=None, sandbox_fusion_url=None, concurrent_semaphore=None):
    ...
    elif data_source in ["discoveryworld_action", "discoveryworld/action"]:
        from . import discoveryworld_action

        res = discoveryworld_action.compute_score(solution_str, ground_truth)
    else:
