...
export EXPERIMENT_TAG="gigpo-use-0709"
export DISCOVERYWORLD_ENV_VARIANT=derustmoderate

export RESUME_MODE=resume_path
export RESUME_FROM_PATH="/home/xlan1/projects/verl-agent/checkpoints/Combinatorial-Chemistry-Agent/gigpo-pickjar-0709-envseed0-cseed0/global_step_40"
