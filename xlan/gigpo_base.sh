...
# GiGPO
GIGPO_STEP_ADVANTAGE_W="${GIGPO_STEP_ADVANTAGE_W:-1.5}"
...
case "${DISCOVERY_TASK}" in
    chemistry)
        ...
        DEFAULT_EXPERIMENT_TAG="gigpo-n${MAX_CHEMICAL_N:-2}"
        ;;
    plant)
        ...
        DEFAULT_EXPERIMENT_TAG="gigpo-plant-normal"
        ;;
    reactor)
        ...
        DEFAULT_EXPERIMENT_TAG="gigpo-reactor-normal"
        ;;
    *)
